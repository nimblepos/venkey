...
//        String var="{\"Roles\":[{\"role\":\"owner\"},{\"role\":\"cashier\"},{\"role\":\"stock_manager\"},{\"role\":\"accounts\"},{\"role\":\"manager\"}]}";
        //get current user
//        final FirebaseUser user = FirebaseAuth.getInstance().getCurrentUser();

//        Map<String, String> users = new HashMap<>();
//        users.put("currency_symbol" ,"$");
//        users.put("paypal_client_id" ,"XXXXX");
//        users.put("sale_receipt_id" ,"8");
//        users.put("require_staff_on_checkout" ,"1");
//        users.put("currency_type" ,"USD");
//        users.put("require_customer_on_credit_checkout" ,"1");
//        users.put("allow_user_registration" ,"1");
//        users.put("allow_saas" ,"true");
//        users.put("crypts" ,"com.bytecodecomp.npos");
//        users.put("store_uid " ,"");
//        users.put("device_role" ,"");
//        users.put("staff_uid" ,"0");
//        users.put("staff_permissions" ,"0");
//        users.put("current_activity" ,"");
//        users.put("default_printer" ,"BlueTooth Printer");
//        users.put("json_user_roles" ,var);
//        users.put("user_role" ,"");
//        users.put("admin_uid","Ocn7ikG2ZSQJRWuO8coI2sf7FED3");
//        ref.setValue(users);
