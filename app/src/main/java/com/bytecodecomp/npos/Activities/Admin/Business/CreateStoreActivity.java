    ...
    public void do_add_store_details(final String store_name, final String store_address, final String store_location, final String store_print, final String store_contacts){
        ...
        storeDatabaseReference.child(user.getUid()).setValue(store_model).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void aVoid) {
                ...
                App_Setting_Util.getAppSettingInstance().store_name = store_name;
                App_Setting_Util.getAppSettingInstance().store_address = store_address;
                App_Setting_Util.getAppSettingInstance().store_location = store_location;
                App_Setting_Util.getAppSettingInstance().store_contacts = store_contacts;
                App_Setting_Util.getAppSettingInstance().store_status = "";
