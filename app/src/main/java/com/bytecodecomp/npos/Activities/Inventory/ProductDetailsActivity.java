...
public class ProductDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        et_product_price.setText(org_product_value + " " + App_Setting_Util.getAppSettingInstance().getCurrency_type());
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch(itemId) {
            ...
            case R.id.action_print:
                ...
                App_Setting_Util.getAppSettingInstance().setCurrent_activity("ProductDetailsActivity");
