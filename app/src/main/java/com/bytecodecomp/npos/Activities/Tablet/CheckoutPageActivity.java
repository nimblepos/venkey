...
public class CheckoutPageActivity extends AppCompatActivity {
    ...
    String Sale_Receipt = AppUtils.getRandomString(App_Setting_Util.getAppSettingInstance().getSale_receipt_id());
    ...
    private static PayPalConfiguration config = new PayPalConfiguration()
            ...
            .clientId(App_Setting_Util.getAppSettingInstance().getPaypal_client_id());


    String  date;
    String Currency = App_Setting_Util.getAppSettingInstance().getCurrency_type();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txt_customer_discount.setText(customer_discount + " " + App_Setting_Util.getAppSettingInstance().getCurrency_type());
        ...
        card_cash.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (App_Setting_Util.getAppSettingInstance().getRequire_staff_on_checkout() == 0){
...
//                            Log.e("VAT...", str_vat);
                        ...
                        if (customer_discount != 0){
                            ...
                            txt_total_amount.setText(App_Setting_Util.getAppSettingInstance().getCurrency_type() + " " + paymentAmount);
                            txt_subtotal_vat.setText(App_Setting_Util.getAppSettingInstance().getCurrency_type() + " " + vat_sub_total);
                        ...
                        txt_total_vat.setText(App_Setting_Util.getAppSettingInstance().getCurrency_type() + " " + vat_total);
    ...
    public void do_receipt_print(String BILL){
        ...
        if (App_Setting_Util.getAppSettingInstance().store_print.equals("YES")){

            Intent intents = new Intent(this, com.bytecodecomp.npos.Plugins.Printer.MainActivity.class);
            intents.putExtra("action", BILL);
            App_Setting_Util.getAppSettingInstance().setCurrent_activity ( "CheckoutPageActivity");
            onsale = false;
    ...
    public String print_receipt(){
        ...
        BILL =  BILL + App_Setting_Util.getAppSettingInstance().store_name + "\n"
                + "TEL :: " + App_Setting_Util.getAppSettingInstance().store_contacts + "\n"
                + "TIME :: "  + date + "\n"
        ...
        BILL = BILL + "Total VAT Value ::  " + vat_sub_total + " " + App_Setting_Util.getAppSettingInstance().getCurrency_type() + "\n";
        BILL = BILL + "Sub Total Value ::  " + paymentAmount + " " + App_Setting_Util.getAppSettingInstance().getCurrency_type() + "\n";
        BILL = BILL + "Discounts Value ::  " + customer_discount + " " + App_Setting_Util.getAppSettingInstance().getCurrency_type() + "\n";
