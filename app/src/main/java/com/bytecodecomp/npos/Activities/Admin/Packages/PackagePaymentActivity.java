...
public class PackagePaymentActivity extends AppCompatActivity {
    ...
    public void do_subscription(){
        ...
        Subscriptions_Model subscriptions_model = new Subscriptions_Model(id, current_date, package_name, package_id, amount, App_Setting_Util.getAppSettingInstance().store_name, user.getProviderId(), exp_date, Sale_Receipt, amount);
