...
import com.bytecodecomp.npos.Utils.App_Setting_Util;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSignup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (App_Setting_Util.getAppSettingInstance().getAllow_user_registration() == 1 ){
...
//                Toast.makeText(LoginActivity.this, "onRewardedVideoStarted", Toast.LENGTH_SHORT).show();
                ...
                if (size == 0){
                    ...
                    while((iterator.hasNext())){
                        ...
                        if (decrypt.decryptIt(value.getStaff_password()).equals(password)){
                            ...
                            App_Setting_Util.getAppSettingInstance().setStaff_uid(staff_uid_list.get(0));
                            App_Setting_Util.getAppSettingInstance().setStaff_permissions(staff_perms_list.get(0));
                            Log.e("staff_uid...", App_Setting_Util.getAppSettingInstance().getStaff_uid());
                            Log.e("staff_permissions...", App_Setting_Util.getAppSettingInstance().getStaff_permissions());
                    ...
                    if (store_model.getStore_status().equals("active")){
                        ...
                        try {
                            ...
                            if (!new Date().after(strDate)) {
                                ...
                                App_Setting_Util.getAppSettingInstance().store_name = store_model.getStore_name();
                                App_Setting_Util.getAppSettingInstance().store_address = store_model.getStore_address();
                                App_Setting_Util.getAppSettingInstance().store_location = store_model.getStore_location();
                                App_Setting_Util.getAppSettingInstance().store_print = store_model.getStore_print();
                                App_Setting_Util.getAppSettingInstance().store_contacts = store_model.getStore_contacts();
                                App_Setting_Util.getAppSettingInstance().package_id = store_model.getPackage_id();
                                App_Setting_Util.getAppSettingInstance().package_name = store_model.getPackage_name();
                                App_Setting_Util.getAppSettingInstance().package_expiry = store_model.getPackage_expiry();
                                App_Setting_Util.getAppSettingInstance().store_status = store_model.getStore_status();
                                App_Setting_Util.getAppSettingInstance().setStaff_uid(dataSnapshot.getKey());

                                Log.e("UID...",  App_Setting_Util.getAppSettingInstance().getStore_uid());
    ...
    public void check_device(){
        ...
        deviceDatabaseReference.child(App_Setting_Util.getAppSettingInstance().getStaff_uid()).orderByChild("device_serial").equalTo(Build.SERIAL).addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                // get total available quest
                int size = (int) dataSnapshot.getChildrenCount();
                ...
                if (size == 0){
                    ...
                    while((iterator.hasNext())){
                        ...
                        App_Setting_Util.getAppSettingInstance().setDevice_role(device_role_list.get(0));
                        Log.e("Device_Role...", App_Setting_Util.getAppSettingInstance().getDevice_role());
    ...
    public void confirm_device_role(){
        ...
        if (App_Setting_Util.getAppSettingInstance().getDevice_role().equals("merchant_admin")){
        ...
        else if (App_Setting_Util.getAppSettingInstance().getDevice_role().equals("staff")){
