            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                while((iterator.hasNext())){
                    ...
                    if (value.getPayment_user_staff().equals(staff_names)){
                        ...
                        txt_staff_commission.setText("Commission " + App_Setting_Util.getAppSettingInstance().getCurrency_type() + " " + total_commision);
                        txt_staff_sales.setText("Sales " + App_Setting_Util.getAppSettingInstance().getCurrency_type()+ " " + total_sales);
