...
public class Checkout_Page_Adapter extends BaseAdapter {
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) view = inflater.inflate(R.layout.item_product_page_checkout, null);
        {
            ...
            ((TextView) view.findViewById(R.id.txt_Product_Price)).setText(String.valueOf(product_value.get(i)) + "  =  " + App_Setting_Util.getAppSettingInstance().getCurrency_type() + " " + total);
