...
public class Purchase_Adapter extends BaseAdapter {
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        lyt_purchase.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                alertDialogBuilder.setMessage("Purchase for " + purchase_qnty.get(i) + " units of " + purchase_item.get(i) + " worth " + purchase_buying_price.get(i) + " " + App_Setting_Util.getAppSettingInstance().getCurrency_type() + " per unit");
                alertDialogBuilder.setPositiveButton("Print",
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface arg0, int arg1) {
                                ...
                                App_Setting_Util.getAppSettingInstance().setCurrent_activity( "Purchase_Adapter");
    ...
    public String print_purchase(int position){
        ...
        purchase = purchase + "\nCOST : " + purchase_buying_price.get(position) + " " + App_Setting_Util.getAppSettingInstance().getCurrency_type();
