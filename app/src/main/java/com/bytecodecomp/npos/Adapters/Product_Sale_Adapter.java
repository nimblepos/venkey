...
//    private ValueEventListener listener = AppController.listener;
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        ((TextView)view.findViewById(R.id.txt_product_price)).setText( "SKU : " + String.valueOf(product_gtin.get(i))  + " / PRICE : " + App_Setting_Util.getAppSettingInstance().getCurrency_type() + " " +  String.valueOf(product_value.get(i)));
