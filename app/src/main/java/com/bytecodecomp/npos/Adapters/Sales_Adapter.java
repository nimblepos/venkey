...
public class Sales_Adapter extends BaseAdapter {
    ...
    public void show_payments_status(final int i){
        ...
        txt_amount.setText( App_Setting_Util.getAppSettingInstance().getCurrency_type() + "  " + payment_amount.get(i));
...
//                dialog.dismiss();
        ...
        if (payment_method.get(i).equals("Credit")){
            ...
            txt_credit.setText( App_Setting_Util.getAppSettingInstance().getCurrency_type() + "  " + payment_amount.get(i));
        ...
        ((FloatingActionButton) dialog.findViewById(R.id.fab_print)).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                App_Setting_Util.getAppSettingInstance().setCurrent_activity("Sales_Adapter");
